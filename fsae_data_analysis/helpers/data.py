...
def process_analysis_data(csv_name):
    y_cols = ["Time", "G Force Long", "G Force Lat", "Damper Pos FL", "Damper Pos FR", "Damper Pos RL", "Damper Pos RR", "Wheel Speed FL", "Wheel Speed FR", "Wheel Speed RL", "Wheel Speed RR", "Steering Wheel Angle", "Brake Pressure Front","Brake Pressure Rear"]
